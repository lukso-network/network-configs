...
function start_eth2stats {
	...
	nohup ./bin/eth2stats-client run \
	--beacon.type=prysm \
...
function generate_genesis {
	...
	--eth1-deposit-root 0xec1a67bb90fa79f71c49886243b455b26c89f8715a6b54b6abaac20c4d1c308b
	# --timestamp $(date +%s)
}
...
function reset_deposit_validator {
	echo "shutting down deposit validator client..."
    sudo kill -INT $(sudo lsof -t -i:7002) &>/dev/null
	sleep 1
...
function main {
	...
	while $choiceloop; do
		...
		echo "9. Reset deposit validator"
